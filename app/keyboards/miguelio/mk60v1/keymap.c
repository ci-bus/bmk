...
const uint16_t layers[LAYERS][MATRIX_COLS * MATRIX_ROWS + ENCODER_PINS] = {
    {
        ...
        HID_KEY_NONE, HID_KEY_VOLUME_UP, HID_KEY_D, HID_KEY_G, HID_KEY_J, HID_KEY_L, HID_KEY_APOSTROPHE, HID_KEY_ENTER,                                                                               // Row 4
        HID_KEY_NONE, HID_KEY_NONE, HID_KEY_VOLUME_DOWN, HID_KEY_F, HID_KEY_H, HID_KEY_K, HID_KEY_SEMICOLON, HID_KEY_BACKSLASH,                                                                         // Row 5
