...
const uint16_t layers[LAYERS][MATRIX_COLS * MATRIX_ROWS + ENCODERS * ENCODER_PINS] = {
    {
        ...
        HID_DEEP_SLEEP, HID_KEY_NONE, HID_KEY_2, HID_KEY_4, HID_KEY_6, HID_KEY_8, HID_KEY_0, HID_KEY_EQUAL,                // Row 0
        ...
        HID_KEY_NONE, HID_KEY_Z, HID_KEY_C, HID_KEY_B, HID_KEY_M, HID_KEY_DOT, HID_KEY_RIGHT, HID_KEY_SLASH,               // Row 6
