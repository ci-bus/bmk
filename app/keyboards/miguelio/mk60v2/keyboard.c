...
const struct gpio_dt_spec cols[MATRIX_COLS] = {
    ...
    {.port = GPIO0, .pin = 15, .dt_flags = GPIO_ACTIVE_HIGH}, /* Col 1: P0.22 */
    {.port = GPIO1, .pin = 0, .dt_flags = GPIO_ACTIVE_HIGH},  /* Col 2: P0.31 */
    {.port = GPIO0, .pin = 10, .dt_flags = GPIO_ACTIVE_HIGH}, /* Col 3: P0.29 */
    {.port = GPIO1, .pin = 13, .dt_flags = GPIO_ACTIVE_HIGH}, /* Col 4: P0.02 */
    {.port = GPIO0, .pin = 3, .dt_flags = GPIO_ACTIVE_HIGH},  /* Col 5: P1.13 */
    {.port = GPIO0, .pin = 2, .dt_flags = GPIO_ACTIVE_HIGH},  /* Col 6: P0.03 */
    {.port = GPIO0, .pin = 29, .dt_flags = GPIO_ACTIVE_HIGH}, /* Col 7: P1.11 */
};
...
const struct gpio_dt_spec rows[MATRIX_ROWS] = {
    ...
    {.port = GPIO0, .pin = 9, .dt_flags = GPIO_ACTIVE_HIGH}, /* Row 2: P0.10 */
    {.port = GPIO0, .pin = 8, .dt_flags = GPIO_ACTIVE_HIGH},  /* Row 3: P0.04 */
    ...
    {.port = GPIO0, .pin = 17, .dt_flags = GPIO_ACTIVE_HIGH},  /* Row 8: P1.06 */
};
