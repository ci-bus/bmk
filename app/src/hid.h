...
#define HID_KEY_POWER_ON (K_SPECIAL | 0x02)
#define HID_KEY_POWER_OFF (K_SPECIAL | 0x03)

#define HID_KEY_RGB_LIGHT (K_SPECIAL | 0x04)
#define HID_KEY_RGB_COLOR (K_SPECIAL | 0x05)
#define HID_KEY_RGB_SATURATION (K_SPECIAL | 0x06)
#define HID_KEY_RGB_ON (K_SPECIAL | 0x07)
#define HID_KEY_RGB_OFF (K_SPECIAL | 0x08)
#define HID_KEY_RGB_TOGGLE (K_SPECIAL | 0x09)

#define HID_BT_CLEAR (K_SPECIAL | 0x0A)
#define HID_DEEP_SLEEP (K_SPECIAL | 0x0B)
#define HID_RESET (K_SPECIAL | 0x0C)
#define HID_BOOT (K_SPECIAL | 0x0D)
